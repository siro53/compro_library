...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/data-structure/erasable-priority-queue.test.cpp\"\
    ...
    #line 8 \"data-structure/erasable-priority-queue.hpp\"\n\ntemplate<class T, bool\
    ...
    \ T& val) {\n        rm_que.emplace(val);\n    }\n\n    bool empty() {\n     \
    \   return que.empty();\n    }\nprivate:\n    void normalize() {\n        while(!que.empty()\
    \ and !rm_que.empty() and que.top() == rm_que.top()) {\n            que.pop();\n\
    \            rm_que.pop();\n        }\n    }\n};\n#line 5 \"test/mytest/data-structure/erasable-priority-queue.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/mytest/data-structure/erasable-priority-queue.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/data-structure/erasable-priority-queue.test.cpp
- /verify/test/mytest/data-structure/erasable-priority-queue.test.cpp.html
