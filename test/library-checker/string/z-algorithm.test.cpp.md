...
data:
  ...
  bundledCode: "#line 1 \"test/library-checker/string/z-algorithm.test.cpp\"\n#define\
...
layout: document
redirect_from:
- /verify/test/library-checker/string/z-algorithm.test.cpp
- /verify/test/library-checker/string/z-algorithm.test.cpp.html
